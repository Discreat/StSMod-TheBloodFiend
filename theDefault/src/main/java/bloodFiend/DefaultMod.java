...
import bloodFiend.cards.*;
import bloodFiend.characters.TheDefault;
import bloodFiend.events.IdentityCrisisEvent;
import bloodFiend.potions.PlaceholderPotion;
import bloodFiend.relics.BottledPlaceholderRelic;
import bloodFiend.relics.DefaultClickableRelic;
import bloodFiend.relics.PlaceholderRelic;
import bloodFiend.relics.PlaceholderRelic2;
import bloodFiend.util.IDCheckDontTouchPls;
import bloodFiend.util.TextureLoader;
import bloodFiend.variables.DefaultCustomVariable;
import bloodFiend.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    private static final String ATTACK_DEFAULT_GRAY = "bloodFiendResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "bloodFiendResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "bloodFiendResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "bloodFiendResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "bloodFiendResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "bloodFiendResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "bloodFiendResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "bloodFiendResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "bloodFiendResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "bloodFiendResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "bloodFiendResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "bloodFiendResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "bloodFiendResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "bloodFiendResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "bloodFiendResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "bloodFiendResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "bloodFiendResources/images/char/defaultCharacter/skeleton.json";
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("BloodFiend") // ${project.artifactId}
