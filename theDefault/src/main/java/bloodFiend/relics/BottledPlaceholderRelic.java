...
import bloodFiend.patches.relics.BottledPlaceholderField;
import bloodFiend.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static bloodFiend.DefaultMod.makeRelicOutlinePath;
import static bloodFiend.DefaultMod.makeRelicPath;
